...
TEMPJSON=(`\
curl --silent --location --request POST "${C1URL}/api/application/accounts/groups/"   --header 'Content-Type: application/json' --header "${C1AUTHHEADER}" --header 'api-version: v1'  --data-raw "${PAYLOAD}" \
`)
