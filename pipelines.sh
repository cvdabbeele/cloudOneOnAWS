...
#creating new pipeline/stack
  ...
  DUMMY=`aws cloudformation create-stack --stack-name ${1}Pipeline --region ${AWS_REGION} --tags Key=${TAGKEY0},Value=${TAGVALUE0} Key=${TAGKEY1},Value=${TAGVALUE1} Key=${TAGKEY2},Value=${TAGVALUE2}  --template-body file://work/${1}Pipeline.yml  --capabilities CAPABILITY_IAM`
